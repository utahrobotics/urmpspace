...
class Roboclaw:
	...
	def __init__(self, comport, rate, timeout=0.1, retries=1):
	...
	def Open(self):
		try:
			self._port = serial.Serial(port=self.comport, baudrate=self.rate, timeout=0.05, interCharTimeout=self.timeout)
		except:
			return 0
		return 1
